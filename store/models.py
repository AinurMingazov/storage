...
class Keeper(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("store:tool_list_by_keeper", args=[self.slug])
...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("store:tool_list_by_category", args=[self.slug])
...
class Tool(models.Model):
    ...
    keeper = models.ForeignKey(Keeper, on_delete=models.SET_NULL, related_name="keeper", null=True)
...
class Operation(models.Model):
    ...
    giver = models.ForeignKey(Keeper, related_name="giver", on_delete=models.CASCADE)
    taker = models.ForeignKey(Keeper, related_name="taker", on_delete=models.CASCADE)
